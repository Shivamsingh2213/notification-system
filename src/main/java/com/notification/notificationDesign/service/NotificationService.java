...
public class NotificationService {
    ...
    public void sendNotification(Long garageId, Long customerId, NotificationType type, String message) throws Exception {
...
//    }
        public List<String> getByCriteria (Long id, LocalDateTime date, NotificationType notificationType){
            List<String> msg=notificationRepository.findMessagesByIdOrDateOrType(id, date, String.valueOf(notificationType));
            return msg;
        }
